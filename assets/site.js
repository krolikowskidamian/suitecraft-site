...
const tourSlides=[
	...
	{tab:'Change Plans',kicker:'RELEASE PLANNING',title:'Turn a list of changes into a release plan.',description:'Collect structural changes and supporting references, compare them with a target account and prepare practical release notes.',points:['Target readiness and blockers','Release and technical notes','Markdown, CSV and JSON export'],image:'08-change-plans.png',step:8},
